//
// Created by icsfy on 18-8-8.
//

#ifndef CPPWEBFRAMEWORK_SERVER_HTTPS_H
#define CPPWEBFRAMEWORK_SERVER_HTTPS_H
...
namespace WebFramework {
    ...
    public:
        // 一个 HTTPS 的服务器比 HTTP 服务器多增加了了两个参数, 一个是证书文件, 另一个是私钥文件
    ...
    private:
        // 和 HTTP 服务器相比, 需要多定义一个 ssl content 对象
...
#endif //CPPWEBFRAMEWORK_SERVER_HTTPS_H
